...
const Work = ({ position, company, location, type, duration })=> {
  ...
  return (
    <article className=" container text-center p-8">
      <div  className="flex justify-around items-center">
        <h1  className="text-content md:text-lg lg:text-xl">{position}</h1>
        <div className="btn bg-green-400 text-black text-xs inline-block rounded-3xl px-3 py-1 min-w-fit">
          {type}
        </div>
      </div>
      <div className="flex justify-around pt-2">
        <div className="flex flex-col md:flex-row border-b-2">
          <div className="flex items-center pr-5">
            <svg
              className="fill-white min-w-fit"
              width="16"
              height="12"
              viewBox="0 0 16 12"
              fill="none"
            ...
            <p className="text-content md:text-lg font-light pl-1">{company}</p>
          </div>
          <div className="flex items-center">
            ...
            <p className="text-content text-center md:text-lg font-light pl-1 ">{location}</p>
          </div>
        </div>
        <p className="text-content md:text-lg font-light pl-1 min-w-fit border-b-2">{duration}</p>
      </div>
    </article>
  );
}
